...
###        db.send_create_signal('collection_record', ['Publisher'])
        ...
        # Adding field 'CollectionRecord.publisher'
        db.add_column('collection_record_collectionrecord', 'publisher', self.gf('django.db.models.fields.related.ForeignKey')(default=34, to=orm['oac.Institution']), keep_default=False)
...
###        db.delete_table('oac_institution')
        ...
        # Deleting field 'CollectionRecord.publisher'
        db.delete_column('collection_record_collectionrecord', 'publisher_id')
    ...
    models = {
        ...
        'collection_record.publisher': {
            'Meta': {'ordering': "['name']", 'object_name': 'Publisher', 'db_table': "'oac_institution'", '_ormbases': ['oac.Institution'], 'proxy': 'True'}
        },
