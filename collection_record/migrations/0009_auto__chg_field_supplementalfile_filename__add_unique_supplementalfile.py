...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SupplementalFile.filename'
        db.alter_column('collection_record_supplementalfile', 'filename', self.gf('django.db.models.fields.CharField')(max_length=78))

        # Adding unique constraint on 'SupplementalFile', fields ['collection_record', 'filename']
        db.create_unique('collection_record_supplementalfile', ['collection_record_id', 'filename'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SupplementalFile', fields ['collection_record', 'filename']
        db.delete_unique('collection_record_supplementalfile', ['collection_record_id', 'filename'])

        # Changing field 'SupplementalFile.filename'
        db.alter_column('collection_record_supplementalfile', 'filename', self.gf('django.db.models.fields.CharField')(max_length=512))
