...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SupplementalFile.updated_at'
        db.add_column('collection_record_supplementalfile', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 1, 25, 18, 4, 50, 179225), blank=True), keep_default=False)

        # Adding field 'SupplementalFile.created_at'
        db.add_column('collection_record_supplementalfile', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 1, 25, 18, 4, 58, 3422), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SupplementalFile.updated_at'
        db.delete_column('collection_record_supplementalfile', 'updated_at')

        # Deleting field 'SupplementalFile.created_at'
        db.delete_column('collection_record_supplementalfile', 'created_at')
