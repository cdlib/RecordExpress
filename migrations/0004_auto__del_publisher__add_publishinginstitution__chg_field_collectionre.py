...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'CollectionRecord', fields ['title_filing']
        db.delete_unique('collection_record_collectionrecord', ['title_filing'])

####        # Deleting model 'Publisher'
####        db.delete_table('oac_institution')
####
####        # Adding model 'PublishingInstitution'
####        db.create_table('oac_institution', (
####            ,
####        ))
####        db.send_create_signal('collection_record', ['PublishingInstitution'])

        # Changing field 'CollectionRecord.local_identifier'
        db.alter_column('collection_record_collectionrecord', 'local_identifier', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Adding unique constraint on 'CollectionRecord', fields ['publisher', 'title_filing']
        db.create_unique('collection_record_collectionrecord', ['publisher_id', 'title_filing'])

        # Adding unique constraint on 'CollectionRecord', fields ['publisher', 'local_identifier']
        db.create_unique('collection_record_collectionrecord', ['publisher_id', 'local_identifier'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'CollectionRecord', fields ['publisher', 'local_identifier']
        db.delete_unique('collection_record_collectionrecord', ['publisher_id', 'local_identifier'])

        # Removing unique constraint on 'CollectionRecord', fields ['publisher', 'title_filing']
        db.delete_unique('collection_record_collectionrecord', ['publisher_id', 'title_filing'])

####        # Adding model 'Publisher'
####        db.create_table('oac_institution', (
####            ,
####        ))
####        db.send_create_signal('collection_record', ['Publisher'])
####
####        # Deleting model 'PublishingInstitution'
####        db.delete_table('oac_institution')

        # Changing field 'CollectionRecord.local_identifier'
        db.alter_column('collection_record_collectionrecord', 'local_identifier', self.gf('django.db.models.fields.CharField')(max_length=512))

        # Adding unique constraint on 'CollectionRecord', fields ['title_filing']
        db.create_unique('collection_record_collectionrecord', ['title_filing'])
