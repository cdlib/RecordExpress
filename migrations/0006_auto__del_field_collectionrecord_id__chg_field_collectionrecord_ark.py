...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CollectionRecord.id'
        db.delete_column('collection_record_collectionrecord', 'id')

        # Changing field 'CollectionRecord.ark'
        db.alter_column('collection_record_collectionrecord', 'ark', self.gf('django.db.models.fields.CharField')(max_length=255, primary_key=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'CollectionRecord.id'
        raise RuntimeError("Cannot reverse this migration. 'CollectionRecord.id' and its values cannot be restored.")

        # Changing field 'CollectionRecord.ark'
        db.alter_column('collection_record_collectionrecord', 'ark', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True))
